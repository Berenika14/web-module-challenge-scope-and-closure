...
/*Task 1: counterMaker()
  ...
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  
     counter1 is preferable when we want our variable to be private ( so no one can mess up with it and  always gives us the exact count .)
     counter2  maybe can used when we want our variable to be shared by two or more functions.
*/
